...
class User extends CI_Controller {
  ...
  if ($res) {
    echo  $res[0]['turn_off_registration_fee'];
  }
  print_r($res);
    die(); 
        echo "pramod";
            $subject='pramod, Confirm Your New Account';
            ...
            $data['link']='https://webhungers.com/firearms-new-dev/user/email_verification/30baff27a30fa93ee7e26b8292ec8b';
            $data['btn_text']='Verify';

            $data['btn_url']='https://webhungers.com/firearms-new-dev/user/email_verification/30baff27a30fa93ee7e26b8292ec8b';
            $msg['data']=$data;

            $email="pramodc2311@gmail.com";
            //$this->send_email_new($email,$subject,$msg);
          echo  $check_email=$this->common_model->send_email_new($email,$subject,$msg);
