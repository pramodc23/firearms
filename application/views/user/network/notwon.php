<div class="table-section-08">
  <div class="side-by-side">
    <div class="row">
      <div class="col-md-8">
        <p>Show Items- Didn’t Win  &nbsp;&nbsp;All (<?php echo count($network_info); ?>)  <!-- &nbsp;&nbsp;Active (1)  &nbsp;&nbsp;Ended --></p>
      </div>
  ...
  $foundnum =$count;
        ...
        {   
            ...
            if (!($start<=0)){
             ...
             echo " <li><a href='javascript:buying_notwon($prev)'>Prev</a> </li>";    
            }
            //pages 
            ...
            {               
                ...
                for ($counter = 1; $counter <= $max_pages; $counter++)
                {
                    if ($i == $start)
                    {
                        echo " <li  class='active'><a href='javascript:buying_notwon($i)'><b>$counter</b></a></li> ";
                    }
                    else
                    {
                        echo " <li><a href='javascript:buying_notwon($i)'>$counter</a></li> ";
                    }  
                    $i = $i + $per_page;                 
                }
            }
            elseif($max_pages > 10 + ($adjacents * 2))    //enough pages to hide some
            {
                ...
                if(($start/$per_page) < 1 + ($adjacents * 2))        
                {
                    ...
                    for ($counter = 1; $counter < 10 + ($adjacents * 2); $counter++)
                    {
                        if ($i == $start)
                        {
                            echo " <li  class='active'><a href='javascript:buying_notwon($i)'>$counter</a></li> ";
                        }
                        else
                        {
                            echo " <li><a href='javascript:buying_notwon($i)'>$counter</a></li> ";
            ...
            if (!($start >=$foundnum-$per_page)){
              echo " <li><a href='javascript:buying_notwon($next)'>Next</a></li> ";
            }
