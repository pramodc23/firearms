            ...
            <a href="<?php echo base_url('list-details/'.$slug);?>" target="_blank"><p class="text-left"><?php echo $value->title; ?></p> </a>
              ...
              <span class="Curent-01" style="float: left;border-right: 1px solid #cccccc;    padding-right: 5px;">current bid <span class="price-06"><?php
               ...
               if (!empty($currentprice)) {
                ...
                ?></span></span> 
              <span class="Curent-01" >Your highest bid <span class="price-06">
              <?php         
  ...
  $foundnum =$count;
        ...
        {   
            ...
            if (!($start<=0)){
             ...
             echo " <li><a href='javascript:buying_all($prev)'>Prev</a> </li>";    
            }
            //pages 
            ...
            {               
                ...
                for ($counter = 1; $counter <= $max_pages; $counter++)
                {
                    if ($i == $start)
                    {
                        echo " <li  class='active'><a href='javascript:buying_all($i)'><b>$counter</b></a></li> ";
                    }
                    else
                    {
                        echo " <li><a href='javascript:buying_all($i)'>$counter</a></li> ";
                    }  
                    $i = $i + $per_page;                 
                }
            }
            elseif($max_pages > 10 + ($adjacents * 2))    //enough pages to hide some
            {
                ...
                if(($start/$per_page) < 1 + ($adjacents * 2))        
                {
                    ...
                    for ($counter = 1; $counter < 10 + ($adjacents * 2); $counter++)
                    {
                        if ($i == $start)
                        {
                            echo " <li  class='active'><a href='javascript:buying_all($i)'>$counter</a></li> ";
                        }
                        else
                        {
                            echo " <li><a href='javascript:buying_all($i)'>$counter</a></li> ";
            ...
            if (!($start >=$foundnum-$per_page)){
              echo " <li><a href='javascript:buying_all($next)'>Next</a></li> ";
            }
