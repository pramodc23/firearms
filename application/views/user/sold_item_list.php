...
<section id="list-detail">
  <div class="container">   
    <?php if($fixed_list_details ){
      $list_id= $list_details[0]['id'];
      $title= $list_details[0]['title'];
      $fixed_price= $list_details[0]['fixed_price'];
  ...
  <section class="second-box-01">
    <div class="row">
      <div class="col-md-12">
        <img src="<?php echo base_url(); ?>assets/img/listing_photos/<?php echo $item_image; ?>" style="border-radius: inherit;"> <span class="profile-details01"> </span> <span class="caption-new">   <span id="list_title_id"> <?php echo $title; ?></span>  ($<?php echo $fixed_price;?>) | Qty <?php echo $quantity;?></span>
     </div>
   </div>
  </section>
    ...
    <div class="row">     
          ...
          <table class="table table-hover shopping-cart-wrap table-responsive deatails-table">
            <thead class="text-muted">
              <tr>             
                ...
                <th scope="col"  width="10%">Purchased Quantity</th>
      ...
      <?php }else{ ?>
          <div style="text-align: center;margin: 10%">
            <h2>Buyer List Not Available</h2>
          </div>
        </div>
      </div>
  </div>
...
<script type="text/javascript">
    ...
    function paging(list_id,page_id)
    {
        ...
        $.ajax({
            url: "<?php echo base_url();?>user_action/show_sold_item_list",
            method: "POST",
        ...
        $.ajax({
            url: "<?php echo base_url();?>user_action/sold_item_list_page_count",
            method: "POST",
