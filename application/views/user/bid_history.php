...
<section id="list-detail">
  ...
  <section class="second-box-01">
    <div class="row">
      <div class="col-md-12">
        <img src="<?php echo base_url(); ?>assets/img/listing_photos/<?php echo $item_image; ?>" style="border-radius: inherit;"> <span class="profile-details01"> </span> <span class="caption-new">Bid History - <span id="list_title_id"> <?php echo $title; ?></span>  </span>
     </div>
   </div>
  </section>
