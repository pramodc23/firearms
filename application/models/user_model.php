...
class User_model extends CI_Model
{
    ...
    function get_user_contacts($user_id,$order_by="")
    {
        $sql_query = $this->db->query("SELECT from_user_id,to_user_id FROM (`message`) WHERE (`from_user_id` = $user_id OR `to_user_id` = $user_id) ORDER BY ".$order_by." `created_on` DESC");
...
function select_category($field , $table , $where,$order )
{
