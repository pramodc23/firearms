                    ...
                    <div class="tab-content">
                      <div id="home" class="container tab-pane active"><br>
                        ...
                        <form method="POST" action="<?php echo base_url('listings/list_update');?>">
                          ...
                          <th>Relist</th>
                            <td>   
                              <select name="relist_list" id="relist_list">
                                <option value="yes" >Yes</option>
                                <option value="no" selected="selected">No</option>
                              </select>
                              <input type="hidden" name="list_id" value="<?php echo $list_details[0]['id'];?>">
                              <input type="hidden" name="duration_days" value="<?php echo $list_details[0]['duration_days'];?>">
                              <input type="hidden" name="list_end_auction" value="<?php echo $list_details[0]['end_auction'];?>">
                      ...
                      <div id="menu3" class="container tab-pane fade"><br>
                         <table class="table table-hover c_details">
                          ...
                          <tr>
                            ...
                            if ($list_details[0]['pays_for_shipping']=='1') {
                              echo "Seller Pays For Shipping";
                            }elseif ($list_details[0]['pays_for_shipping']=='2') {
                              echo "Buyer Pays Actual Shipping Cost";
                            }else{
                              echo "Buyer Pays Fixed Amount";
                            }
                          ...
                          <tr>
                            <th>Relist Options</th>
                            <td><?php echo $list_details[0]['relist_options'];?></td>
                          </tr>
                          <tr>
                            <th>Starting Bid</th>
                            <td><?php echo $currency.' '.$list_details[0]['starting_bid'];?></td>
                          </tr>
                          <tr>
                            <th>Reserve Price</th>
                            <td><?php echo $currency.' '.$list_details[0]['reserve_price'];?></td>
                          </tr>
                          <tr>
                            <th>Buy Now! price</th>
                            <td><?php echo $currency.' '.$list_details[0]['buy_now_price'];?></td>
                          </tr>
                        </table>
                      </div>
