            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <select style="margin-left: 10px;padding: 3px;" onchange="window.location.href='<?php echo base_url(); ?>listings/allListings/'+this.value+'/<?php echo $user_id;?>'">
                    ...
                    <div class="box-tools" style="position:relative;">
                        <form action="<?php echo base_url('listings/allListings/'.$type_search) ?>" method="GET" id="searchList">
                ...
                <div class="box-body table-responsive no-padding" id="checkboxes">
                  <table class="table table-hover">
                    <tr>
                      ...
                      <?php if($current_Price_show){ ?>                   
                      <th width="10%">Current Price</th>
                      <?php } if($reserve_Price_show){ ?> 
                      <th width="10%">Reserve Price</th>
                      <?php } if($buynow_Price_show){ ?>
                      <th width="5%">Buy Now Price</th>  
                      <?php } if($bid_counts_show){ ?>
                      <th width="5%">Bid Count</th>  
                    ...
                    echo  substr($record->title,0,30);?></td>
